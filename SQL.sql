...
insert into Books(TITLE, ISBN, PUBLICATION_DATE, GENRE, AVAILABLE) 
Values('The Martian','978-0316031617','2011-10-26','Sci-Fi',TRUE),
	  ('Jane Eyre','978-0140620611','1847-10-19','Romance',TRUE),
      ('The Lord of the Rings','978-0345339774','1970-07-22','Fantasy',TRUE);
